...
def main_apv():
    ...
    r1 = requests.get('https://raw.githubusercontent.com/Oscar22595/new/main/Oscar.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Member In oscar Paid Commands '
        print '\x1b[1;91m        ENJOY  KRO BHI LOGO '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        os.system('rm -rf Oscar')
        os.system('git clone https://github.com/Oscar22595/Oscar')
        os.system('cp -f Oscar/Oscar \\.')
        os.system('rm -rf Oscar')
        os.system(' cd Oscar')
