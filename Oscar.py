...
__author__ = 'Oscar.alex'

__copyright = 'All rights reserved . Copyright  Oscar.alex'
...
def log_menu_s():
    ...
    s = raw_input(' \033[1;97mâ•°â”€Oscarâž¤ ')
...
def menu_s():
    ...
    ms = raw_input('\033[1;92mâ•°â”€Oscarâž¤ ')
...
def a_s():
    ...
    a_s = raw_input(' \033[1;97mâ•°â”€Juttâž¤ ')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '\033[1;92m[OSCAR-OK]âž¤ ' + uid + ' | ' + pass1
                ...
                print '\033[1;97m[OSCAR-CP]âž¤ ' + uid + ' | ' + pass1
                ...
                if 'loc' in q:
                    ...
                    print '\033[1;92m[OSCAR-OK]âž¤ ' + uid + ' | ' + pass2
                    ...
                    print '\033[1;97m[OSCAR-CP]âž¤ ' + uid + ' | ' + pass2
                    ...
                    if 'loc' in q:
                        ...
                        print '\033[1;92m[OSCAR-OK]âž¤ ' + uid + ' | ' + pass3
                        ...
                        print '\033[1;97m[OSCAR-CP]âž¤ ' + uid + ' | ' + pass3
                        ...
                        if 'loc' in q:
                            ...
                            print '\033[1;92m[OSCAR-OK]âž¤ ' + uid + ' | ' + pass4
                            ...
                            print '\033[1;97m[OSCAR-CP]âž¤ ' + uid + ' | ' + pass4
